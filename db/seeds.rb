...
Writing.create(text: "Affirmative")
Writing.create(text: "Amused")
...
Writing.create(text: "Awe")
Writing.create(text: "Beaming")
Writing.create(text: "Beauty")
...
Writing.create(text: "Delighted")
Writing.create(text: "Demagogue")
Writing.create(text: "Dynamic")
Writing.create(text: "Eccentric")
Writing.create(text: "Elated")
Writing.create(text: "Energetic")
Writing.create(text: "Entertained")
Writing.create(text: "Envy")
Writing.create(text: "Ephemeral")
Writing.create(text: "Euphoric")
Writing.create(text: "Excited")
Writing.create(text: "Exhilirated")
Writing.create(text: "Exude")
Writing.create(text: "Fantastic")
Writing.create(text: "Fickle")
Writing.create(text: "Frenetic")
Writing.create(text: "Giddy")
Writing.create(text: "Gleeful")
Writing.create(text: "Gloom")
Writing.create(text: "Gratified")
Writing.create(text: "Haggard")
Writing.create(text: "Happy")
Writing.create(text: "Havoc")
Writing.create(text: "Hopeful")
